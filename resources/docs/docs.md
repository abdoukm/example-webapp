<h2 class="alert alert-success">Congratulations, your <a class="alert-link" href="http://luminusweb.net">Luminus</a> site is VERY VERY VERY ready!</h2>

This page will help guide you through the first steps of building your site.

#### Why are you seeing this page?

The `home-routes` handler in the `example-webapp.routes.home` namespace
...
The `home-page` function will in turn call the `example-webapp.layout/render` function
...
The routes are aggregated and wrapped with middleware in the `example-webapp.handler` namespace:
...
Request middleware functions are located under the `example-webapp.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `example-webapp.dev-middleware` namespace found in
